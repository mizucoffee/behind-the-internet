...
pinPage('#anim-3', '450%')
animate('#dns1', "#anim-3-content", "70%", "130%", {left: 'calc(100% - 350px)', top: 0})
fadeout('#dns1', "#anim-3-content", "140%", "170%")

fadein('#dns2', "#anim-3-content", "190%", "220%")
animate('#dns2', "#anim-3-content", "230%", "290%", {left: '0px', top: 'calc(50% - 55px)'})
fadeout('#dns2', "#anim-3-content", "300%", "330%")

fadein('#dns3', "#anim-3-content", "350%", "380%")
animate('#dns3', "#anim-3-content", "390%", "450%", {left: 'calc(100% - 350px)', bottom: 0})
fadeout('#dns3', "#anim-3-content", "460%", "490%")

fadein('#dns4', "#anim-3-content", "510%", "540%")
animate('#dns4', "#anim-3-content", "550%", "610%", {left: '0px', bottom: 'calc(50% - 55px)'})
